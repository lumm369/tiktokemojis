          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center space-y-6 max-w-4xl mx-auto">
              ...
              <div className="space-y-6">
                ...
                {/* Special Emojis Filter */}
                <div className="flex justify-center gap-2 max-w-xl mx-auto">
                  <Button
                    variant={showSpecial === 'all' ? 'default' : 'outline'}
                  ...
                  <Button
                    variant={showSpecial === 'special' ? 'default' : 'outline'}
                    onClick={() => handleSpecialFilter('special')}
                    className={showSpecial === 'special' ? "bg-[#FE2C55] text-white" : ""}
                  >
                    Secret Emojis
                  </Button>
                  <Button
                    variant={showSpecial === 'standard' ? 'default' : 'outline'}
                    onClick={() => handleSpecialFilter('standard')}
                    className={showSpecial === 'standard' ? "bg-[#FE2C55] text-white" : ""}
                  >
                    Standard Emojis
                  </Button>
                </div>
